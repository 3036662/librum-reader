...
Item {
    ...
    property string sidebarOpdsLibs
    ...
    states: [
        State {
            ...
            PropertyChanges {
                target: iconSheet
                sidebarOpdsLibs: "/resources/images/light_mode/sidebar/library_icon.svg"
            }
            PropertyChanges {
                target: iconSheet
        ...
        State {
            ...
            PropertyChanges {
                target: iconSheet
                sidebarOpdsLibs: "/resources/images/dark_mode/sidebar/library_icon.svg"
            }
            PropertyChanges {
                target: iconSheet
