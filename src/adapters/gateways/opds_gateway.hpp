...
class ADAPTERS_EXPORT OpdsGateway : public application::IOpdsGateway
{
    Q_OBJECT
...
public slots:
    ...
    void getBookMedia(const QString& id, const QUuid& uuid,
...
private:
    ...
    void processOpdsImage(const QString& id, const QString& url,
