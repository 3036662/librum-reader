...
public:
    ...
    virtual const std::vector<domain::value_objects::OpdsNode>&
        getOpdsNodes() = 0;
    ...
    virtual bool saveOpdsLib(const QString& title, const QString& url,
                             const QString& descr) = 0;
public slots:
    virtual void processNodes(
        const std::vector<domain::value_objects::OpdsNode>&) = 0;
