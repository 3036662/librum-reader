...
public slots:
 ...
 private slots:
    void saveDownloadedBookMediaChunkToFile(const QString& opdsId, const QUuid& uuid,
 ...
 private:
  ...
  void setMediaDownloadProgressForBook(const QString& id, qint64 bytesReceived,
                                       qint64 bytesTotal);
